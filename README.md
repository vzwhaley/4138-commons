...
4138commons.com — hosted on Cloudways ("Moon Whale Media" server `159.203.67.204`), deployed from this repo.

| | |
|---|---|
| Cloudways app id | `axhjjgqadh` |
| Staging URL | https://phpstack-1647922-6572206.cloudwaysapps.com |
| Production | https://4138commons.com (after DNS cutover + SSL) |
...
1. **Domain Management** → add `4138commons.com` + `www.4138commons.com`, set `4138commons.com` primary.
