#!/usr/bin/env bash
#
# Production deploy for 4138commons.com — Laravel 13 + Vue 3 (Cloudways,
...
SSH_HOST="cloudways"
APP_ROOT="/home/master/applications/axhjjgqadh/public_html"   # Laravel app root
WEB_ROOT="$APP_ROOT/public"                                    # nginx docroot (set in panel)
REMOTE_PHP="php8.4"
REMOTE_COMPOSER="/usr/local/bin/composer"
DEPLOY_BRANCH="${DEPLOY_BRANCH:-main}"
STAGING_URL="phpstack-1647922-6572206.cloudwaysapps.com"
